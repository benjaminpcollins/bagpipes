...
def write_alma_transmission_curves(filter_name, central_freq_ghz, bandwidth_ghz):
    ...
    filename = f"/Users/benjamincollins/University/PhD/Code/bagpipes/BlueJay/filters/{filter_name}"
    np.savetxt(
        filename, 
        output_data, 
        fmt=['%.4f', '%.1f'], 
